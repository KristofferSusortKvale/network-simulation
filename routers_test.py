...
plt.bar([str(ele) for ele in num_routers_list], ref_results)
plt.xlabel("Number of routers")
plt.ylabel("Packages completed")
plt.savefig("reference_results_routers")
#plt.show()

plt.bar([str(ele) for ele in num_routers_list], alt_results)
plt.xlabel("Number of routers")
plt.ylabel("Packages completed")
plt.savefig("alternative_results_routers")
#plt.show()
